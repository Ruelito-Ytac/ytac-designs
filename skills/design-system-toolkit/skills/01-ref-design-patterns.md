---
name: design-guide-reference
description: >
  Reference material for UI/UX design: review checklists, Figma workflow best practices,
  design-to-dev handoff, content & UX writing, performance budgets, common anti-patterns,
  iconography system, placeholder images, icon source pages, border radius system,
  data flow design, spacing & sizing enforcement, and modern design patterns (2024-2026).

  Load on demand when the task requires these specific references.
  Core design principles are in 01-design-guide.md.
---

# Design Guide — Reference & Patterns

> **On-demand reference.** Load this file only when the current task needs review checklists,
> Figma workflow tips, iconography rules, spacing enforcement, or modern pattern guidance.
> Core design principles (§1-13) are in `01-design-guide.md`.
